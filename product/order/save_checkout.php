...
$sql = "INSERT INTO orders (order_date,order_name,order_address,order_email,order_tal,order_key)
VALUES ('$datetime','$order_name','$order_address','$order_email','$order_tal','$keyrm') ";
